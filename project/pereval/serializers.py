...
class PerevalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pereval
        fields = ['id', 'beauty_title', 'title', 'other_title', 'content', 'add_time',
    ...
    def create(self, validated_data):
        ...
        pereval_new = Pereval.objects.create(**validated_data, user=user, coord=coord, level=levels)
    ...
    def update(self, instance, validated_data):
        ...
        CoordSerializer().update(instance.coord, coord_data)
